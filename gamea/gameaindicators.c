...
void ConstructGameAIndicators(modelInfo** dynamicModels, Texture2D** gameATextures, int* lastModelIndex, Indicator** allIndicators, ExitCode* exitCode)
{
    ...
    ConstructSingleIndicator(dynamicModels,
			     gameATextures,
			     allIndicators,
			     "D:/CFiles/FirstGame/models/obj/indicators/indicator_12.obj",
    ...
    ConstructSingleIndicator(dynamicModels,
			     gameATextures,
			     allIndicators,
			     "D:/CFiles/FirstGame/models/obj/indicators/indicator_13.obj",
			     (Vector3){0.0f, 0.0f, 0.0f},
			     13,
			     112,
			     &lastIndicatorIndex,
    ...
    ConstructSingleIndicator(dynamicModels,
			     gameATextures,
			     allIndicators,
			     "D:/CFiles/FirstGame/models/obj/indicators/indicator_14.obj",
			     (Vector3){0.0f, 0.0f, 0.0f},
			     13,
			     113,
			     &lastIndicatorIndex,
