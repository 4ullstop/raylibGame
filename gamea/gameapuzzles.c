...
void ConstructGameAPuzzles(ButtonMaster** gameAPuzzles, Texture2D** allTextures, modelInfo** dynamicModels, int* lastModelIndex, FPSPlayer* player, GameplayElements* gameplayElements, SharedMemory* sharedMemory, SharedPuzzleList** sharedPuzzleList, ExitCode* exitCode)
{
    ...
    ConstructSinglePuzzle(&lastPuzzleIndex,
			  ...
			  true,
			  true,
			  (Vector3){-1.1f, 0.0f, -1.0f},
			  exitCode);

    ConstructSinglePuzzle(&lastPuzzleIndex,
			  3,
			  6,
			  (Vector3){-24.0f, 1.0f, -20.0f},
			  player,
			  Puzzle_19,
			  GET_NULL,
			  gameplayElements,
    ...
    RotateButtonMaster(gameAPuzzles[0], 180.0f, (Vector3){0.0f, 1.0f, 0.0f});
    ...
    RotateButtonMaster(gameAPuzzles[21], 90.0f, (Vector3){0.0f, 1.0f, 0.0f});
    RotateButtonMaster(gameAPuzzles[22], 180.0f, (Vector3){0.0f, 1.0f, 0.0f});
    RotateButtonMaster(gameAPuzzles[23], 90.0f, (Vector3){0.0f, 1.0f, 0.0f});
...
void AddGameAPuzzlesToSharedMemory(ButtonMaster** allPuzzles, SharedMemory* sharedMemory)
{
    ...
    allPuzzles[18]->sharedPuzzleId = 3;
    allPuzzles[19]->sharedPuzzleId = 4;
    allPuzzles[20]->sharedPuzzleId = 5;
}
...
void AssignSpecialTexturesGameA(ButtonMaster** allPuzzles, Texture2D** allTextures)
{
    ...
    AssignButtonSpecialTextureAndAction(&allPuzzles[15]->childButtons[0][0], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[15]->childButtons[0][2], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[15]->childButtons[1][1], TCL_OFF); 
    AssignButtonSpecialTextureAndAction(&allPuzzles[15]->childButtons[2][1], TCL_OFF);
    
    AssignButtonSpecialTextureAndAction(&allPuzzles[16]->childButtons[0][0], TCL_Window);

    
    AssignButtonSpecialTextureAndAction(&allPuzzles[17]->childButtons[0][2], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[17]->childButtons[1][0], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[17]->childButtons[1][1], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[17]->childButtons[2][2], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[17]->childButtons[3][2], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[17]->childButtons[3][1], TCL_OFF);
    ...
    AssignButtonSpecialTextureAndAction(&allPuzzles[18]->childButtons[0][0], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[18]->childButtons[2][0], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[18]->childButtons[3][0], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[18]->childButtons[5][0], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[18]->childButtons[1][1], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[18]->childButtons[4][1], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[18]->childButtons[5][1], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[18]->childButtons[2][2], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[18]->childButtons[3][2], TCL_OFF);

    AssignButtonSpecialTextureAndAction(&allPuzzles[19]->childButtons[0][0], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[19]->childButtons[0][1], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[19]->childButtons[0][2], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[19]->childButtons[0][3], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[19]->childButtons[2][3], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[19]->childButtons[3][0], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[19]->childButtons[3][1], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[19]->childButtons[3][2], TCL_OFF);


    AssignButtonSpecialTextureAndAction(&allPuzzles[20]->childButtons[0][2], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[20]->childButtons[1][3], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[20]->childButtons[1][1], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[20]->childButtons[2][3], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[20]->childButtons[2][1], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[20]->childButtons[3][3], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[20]->childButtons[3][1], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[20]->childButtons[4][3], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[20]->childButtons[4][0], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[20]->childButtons[5][3], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[20]->childButtons[5][2], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[20]->childButtons[5][1], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[20]->childButtons[5][0], TCL_OFF); 

    AssignButtonSpecialTextureAndAction(&allPuzzles[21]->childButtons[1][3], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[21]->childButtons[0][3], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[21]->childButtons[2][2], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[21]->childButtons[2][1], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[21]->childButtons[3][1], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[21]->childButtons[3][2], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[21]->childButtons[3][0], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[21]->childButtons[2][3], TCL_SUB);

    AssignButtonSpecialTextureAndAction(&allPuzzles[22]->childButtons[0][2], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[22]->childButtons[0][1], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[22]->childButtons[1][1], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[22]->childButtons[2][1], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[22]->childButtons[2][2], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[22]->childButtons[2][0], TCL_OFF);
    
    AssignButtonSpecialTextureAndAction(&allPuzzles[23]->childButtons[0][1], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[23]->childButtons[1][2], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[23]->childButtons[1][3], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[23]->childButtons[2][1], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[23]->childButtons[2][0], TCL_OFF); 
    AssignButtonSpecialTextureAndAction(&allPuzzles[23]->childButtons[3][0], TCL_OFF); 
    AssignButtonSpecialTextureAndAction(&allPuzzles[23]->childButtons[2][2], TCL_SUB);
    ...
    AssignSolutionsTextures(allPuzzles[16]);
    AssignSolutionsTextures(allPuzzles[17]);
    AssignSolutionsTextures(allPuzzles[18]);
    AssignSolutionsTextures(allPuzzles[19]);
    AssignSolutionsTextures(allPuzzles[20]);
    AssignSolutionsTextures(allPuzzles[21]);
    AssignSolutionsTextures(allPuzzles[22]);
    AssignSolutionsTextures(allPuzzles[23]);
}
...
void Puzzle_20(ButtonMaster* puzzle)
{
    ...
    puzzle->solutionLocations = malloc(sizeof(Vector2Int) * numOfSolutions);
    puzzle->solutionButtons = malloc(sizeof(Button) * puzzle->numberOfSolutions);
    puzzle->solutionLocations[0] = (Vector2Int){1, 5};
...
void Puzzle_21(ButtonMaster* puzzle)
{
    ...
    puzzle->solutionLocations[0] = (Vector2Int){2, 4};
    puzzle->solutionLocations[1] = (Vector2Int){0, 3};
    puzzle->solutionLocations[2] = (Vector2Int){3, 0};
...
void Puzzle_22(ButtonMaster* puzzle)
{
    ...
    puzzle->solutionLocations[2] = (Vector2Int){1, 1};
    puzzle->solutionLocations[3] = (Vector2Int){2, 1};
    puzzle->solutionLocations[4] = (Vector2Int){3, 3};
...
void Puzzle_24(ButtonMaster* puzzle)
{
    int numOfSolutions = 3;
    puzzle->numberOfSolutions = numOfSolutions;
    puzzle->solutionLocations = malloc(sizeof(Vector2Int) * numOfSolutions);
