...
void ConstructGameAPuzzles(ButtonMaster** gameAPuzzles, Texture2D** allTextures, modelInfo** dynamicModels, int* lastModelIndex, FPSPlayer* player, GameplayElements* gameplayElements)
{
    ...
    RotateButtonMaster(gameAPuzzles[9], 45.f, (Vector3){0.0f, 1.0f, 0.0f});
...
{
    AssignButtonSpecialTextureAndAction(&allPuzzles[3]->childButtons[0][1], TCL_OFF);
    ...
    AssignButtonSpecialTextureAndAction(&allPuzzles[7]->childButtons[0][2], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[7]->childButtons[1][2], TCL_OFF);
    AssignButtonSpecialTextureAndAction(&allPuzzles[7]->childButtons[1][3], TCL_OFF);
...
void Puzzle_01(ButtonMaster* puzzle)
{
    ...
    puzzle->textureSizes[0] = EBTS_08;
    puzzle->textureSizes[1] = EBTS_06;
    puzzle->textureSizes[2] = EBTS_04;
    puzzle->textureSizes[3] = EBTS_02;
}
...
void Puzzle_06(ButtonMaster* puzzle)
{
    ...
    puzzle->solutionLocations[1] = (Vector2Int){3, 0};
    puzzle->solutionLocations[2] = (Vector2Int){0, 3};
