...
*/
#define NUMBER_OF_MODELS_A 282 //45
#define NUMBER_OF_MODELS_B 90 //24

#define NUMBER_OF_TEXTURES_A 14 //this will always be one more than what is in the file
#define NUMBER_OF_TEXTURES_B 10

#define NUMBER_OF_INTERACTABLES_A 19 //9
#define NUMBER_OF_INTERACTABLES_B 5

#define NUMBER_OF_AREA_QUERY_BOXES_A 1
#define NUMBER_OF_AREA_QUERY_BOXES_B 1

#define NUMBER_OF_PUZZLES_A 19 //9
#define NUMBER_OF_PUZZLES_B 5
